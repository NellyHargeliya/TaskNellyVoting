...
<head>
    ...
    <script type="text/javascript" src="js/newTheme.js"></script>
</head>
...
<table>
    <tr>
        ...
        <td><INPUT id="nameTheme" type="text" name="nameTheme" title="topic"></td>
    </tr>
    <tr>
    ...
    <tr>
        <td></td>
        <td><button id="addThemeButton" type="button" onclick="newTheme()">Add theme</button></td>
    </tr>
</table>
</body>
</html>
